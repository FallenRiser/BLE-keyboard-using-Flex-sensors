...
if(Val_flex1 < 2300 ){
  ...
  else if(Val_flex1 < 1800 and Val_flex1 > 1500){
    Serial.println('S');
   handleButton(0);
  }
  }
  else if (Val_flex1 > 2300){
      for( int i=0; i < 2; i++){
...
if(Val_flex3 < 3300 ){
  ...
  else if(Val_flex1 < 2600 and Val_flex1 > 2000){
    Serial.println('flex3 2');
   handleButton3(0);
  }
  }
  else if (Val_flex1 > 3300){
      for( int i=0; i < 2; i++){
      // key currently pressed
      x5 = 0;
      x6 = 0;
...
void handleButton(int keyIndex){
  ...
  if (Val_flex1 < 2300) {
    // button pressed
    if (Val_flex1 < 2300 and Val_flex1 > 1900  and x1 == 0){
      // key not currently pressed
      x1 = 1;
      bleKeyboard.press(keyCodes[0]);
    }
    else if (Val_flex1 < 1800 and x2== 0){
      // key not currently pressed
      x2 = 1;
...
void handleButton3(int keyIndex){
  if (Val_flex3 < 3300) {
    // button pressed
    if (Val_flex3 < 3300 and Val_flex3 > 2700  and x5 == 0){
      // key not currently pressed
      x5 = 1;
